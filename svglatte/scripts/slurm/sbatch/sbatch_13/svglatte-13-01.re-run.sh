...
python -m svglatte.train \
 ...
 --experiment_version 'S13.01__BestHparams__Viewbox=64__Seed=72_09.18_18.39.50' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 600 \
 ...
 --test_only --do_not_add_timestamp_to_experiment_version --checkpoint_path logs/svg-latte-hparamsearch/S13.01__BestHparams__Viewbox-64__Seed-72_09.18_18.39.50_S13.01__BestHparams__Viewbox=64__Seed=72_09.18_18.39.50/checkpoints/epoch=579-step=233740.ckpt \
