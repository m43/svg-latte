...
python -m svglatte.train \
 ...
 --experiment_version 'S11.WD.13__latte=h__dec_filters=16__wde=0.0e+00__wdd=5.0e-06_09.15_02.58.47' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 180 \
 ...
 --do_not_add_timestamp_to_experiment_version --checkpoint_path  ./logs/svg-latte-hparamsearch/S11.WD.13__latte-h__dec_filters-16__wde-0.0e+00__wdd-5.0e-06_09.15_02.58.47_S11.WD.13__latte=h__dec_filters=16__wde=0.0e+00__wdd=5.0e-06_09.15_02.58.47/checkpoints/epoch=179-step=50760.ckpt
