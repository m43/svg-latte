...
python -m svglatte.train \
 ...
 --experiment_version 'S11.WD.26__latte=h__dec_filters=64__wde=5.0e-06__wdd=1.0e-05_09.15_07.48.52' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 160 \
 ...
 --encoder_lr 0.00042 \
 --decoder_lr 2.1e-05 \
 --encoder_weight_decay 5e-06 \
 --decoder_weight_decay 1e-05 \
 ...
 --do_not_add_timestamp_to_experiment_version --checkpoint_path  ./logs/svg-latte-hparamsearch/S11.WD.26__latte-h__dec_filters-64__wde-5.0e-06__wdd-1.0e-05_09.15_07.48.52_S11.WD.26__latte=h__dec_filters=64__wde=5.0e-06__wdd=1.0e-05_09.15_07.48.52/checkpoints/epoch=159-step=45120.ckpt
