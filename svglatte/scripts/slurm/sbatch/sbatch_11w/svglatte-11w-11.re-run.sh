...
python -m svglatte.train \
 ...
 --experiment_version 'S11.WD.09__latte=hc__dec_filters=16__wde=0.0e+00__wdd=1.0e-05_09.15_02.52.55' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 190 \
 ...
 --do_not_add_timestamp_to_experiment_version --checkpoint_path  ./logs/svg-latte-hparamsearch/S11.WD.09__latte-hc__dec_filters-16__wde-0.0e+00__wdd-1.0e-05_09.15_02.52.55_S11.WD.09__latte=hc__dec_filters=16__wde=0.0e+00__wdd=1.0e-05_09.15_02.52.55/checkpoints/epoch=189-step=53580.ckpt
