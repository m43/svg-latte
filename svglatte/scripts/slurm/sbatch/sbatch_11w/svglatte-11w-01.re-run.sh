...
python -m svglatte.train \
 ...
 --experiment_version 'S11.WD.04__latte=hc__dec_filters=64__wde=0.0e+00__wdd=0.0e+00_09.15_07.48.52' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 300 \
 ...
 --do_not_add_timestamp_to_experiment_version --checkpoint_path  ./logs/svg-latte-hparamsearch/S11.WD.04__latte-hc__dec_filters-64__wde-0.0e+00__wdd-0.0e+00_09.15_07.48.52_S11.WD.04__latte=hc__dec_filters=64__wde=0.0e+00__wdd=0.0e+00_09.15_07.48.52/checkpoints/last.ckpt
