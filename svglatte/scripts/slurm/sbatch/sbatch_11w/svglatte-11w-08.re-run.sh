...
python -m svglatte.train \
 ...
 --experiment_version 'S11.WD.07__latte=h__dec_filters=16__wde=0.0e+00__wdd=1.0e-05_09.15_02.49.48' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 170 \
 ...
 --do_not_add_timestamp_to_experiment_version --checkpoint_path  ./logs/svg-latte-hparamsearch/S11.WD.07__latte-h__dec_filters-16__wde-0.0e+00__wdd-1.0e-05_09.15_02.49.48_S11.WD.07__latte=h__dec_filters=16__wde=0.0e+00__wdd=1.0e-05_09.15_02.49.48/checkpoints/epoch=169-step=47940.ckpt
