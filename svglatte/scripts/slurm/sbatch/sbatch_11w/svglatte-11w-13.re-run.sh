...
python -m svglatte.train \
 ...
 --experiment_version 'S11.WD.21__latte=hc__dec_filters=16__wde=5.0e-06__wdd=0.0e+00_09.15_02.56.17' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 300 \
 ...
 --do_not_add_timestamp_to_experiment_version --checkpoint_path  ./logs/svg-latte-hparamsearch/S11.WD.21__latte-hc__dec_filters-16__wde-5.0e-06__wdd-0.0e+00_09.15_02.56.17_S11.WD.21__latte=hc__dec_filters=16__wde=5.0e-06__wdd=0.0e+00_09.15_02.56.17/checkpoints/last.ckpt
