...
python -m svglatte.train \
 ...
 --experiment_version 'S11.WD.03__latte=hc__dec_filters=16__wde=0.0e+00__wdd=0.0e+00_09.14_23.33.49' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 300 \
...
--do_not_add_timestamp_to_experiment_version --checkpoint_path  ./logs/svg-latte-hparamsearch/S11.WD.03__latte-hc__dec_filters-16__wde-0.0e+00__wdd-0.0e+00_09.14_23.33.49_S11.WD.03__latte=hc__dec_filters=16__wde=0.0e+00__wdd=0.0e+00_09.14_23.33.49/checkpoints/last.ckpt
