...
#SBATCH -o ./slurm_logs/slurm-sbatch_09-06-%j.out
...
python -m svglatte.train --experiment_name=svglatte_argoverse_128x128_rotAUG --experiment_version 'S9.06_256x256_vbox=64__ARGO4_FC.4c_rotAUG_noLN_noCX_NGF=16_GC=None' --gpus -1 --n_epochs 450 --early_stopping_patience 50 --batch_size=256 --encoder_lr 0.00042 --decoder_lr 0.00042 --encoder_weight_decay 0.0 --decoder_weight_decay 0.0 --encoder_type fc_lstm --lstm_num_layers 4 --latte_ingredients c --decoder_n_filters_in_last_conv_layer 16 --no_layernorm --cx_loss_w 0.0 --dataset=argoverse --argoverse_cached_sequences_format svgtensor_data --argoverse_data_root /scratch/izar/rajic/svgnet-hossein/cache/argo_4/ --argoverse_train_workers 30 --argoverse_val_workers 15 --argoverse_rendered_images_width 256 --argoverse_rendered_images_height 256 --argoverse_viewbox 64 --argoverse_augment_train --argoverse_zoom_preprocess_factor 0.70710678118
