...
#SBATCH -o ./slurm_logs/slurm-sbatch_11-03-%j.out
...
python -m svglatte.train \
 ...
 --experiment_version 'S11.03__latte=c__dec_filters=64_09.11_03.10.16' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 300 \
 ...
 --checkpoint_path  ./logs/svg-latte-hparamsearch/S11.03__latte-c__dec_filters-64_09.11_03.10.16_S11.03__latte=c__dec_filters=64_09.11_03.10.16/checkpoints/last.ckpt \
