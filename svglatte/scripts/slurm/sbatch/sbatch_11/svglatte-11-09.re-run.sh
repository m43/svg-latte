...
#SBATCH -o ./slurm_logs/slurm-sbatch_11-09-%j.out
...
python -m svglatte.train \
 ...
 --experiment_version 'S11.09__latte=hc__dec_filters=64_09.11_03.10.17' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 300 \
 ...
 --checkpoint_path ./logs/svg-latte-hparamsearch/S11.09__latte-hc__dec_filters-64_09.11_03.10.17_S11.09__latte=hc__dec_filters=64_09.11_03.10.17/checkpoints/last.ckpt
