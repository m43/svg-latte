...
python -m svglatte.train \
 ...
 --experiment_version 'S12.01__BestHparams__Seed=72_09.18_18.39.24' \
 --seed 72 \
 --gpus -1 \
 --n_epochs 600 \
 ...
 --test_only --do_not_add_timestamp_to_experiment_version --checkpoint_path logs/svg-latte-hparamsearch/S12.01__BestHparams__Seed-72_09.18_18.39.24_S12.01__BestHparams__Seed=72_09.18_18.39.24/checkpoints/epoch=599-step=241800.ckpt \
