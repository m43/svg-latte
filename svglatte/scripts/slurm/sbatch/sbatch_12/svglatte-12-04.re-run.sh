...
python -m svglatte.train \
 ...
 --experiment_version 'S12.04__BestHparams__Seed=32_09.18_18.39.29' \
 --seed 32 \
 --gpus -1 \
 --n_epochs 600 \
 ...
 --test_only --do_not_add_timestamp_to_experiment_version --checkpoint_path logs/svg-latte-hparamsearch/S12.04__BestHparams__Seed-32_09.18_18.39.29_S12.04__BestHparams__Seed=32_09.18_18.39.29/checkpoints/epoch=559-step=225680.ckpt \
