...
python -m svglatte.train \
 ...
 --test_only --do_not_add_timestamp_to_experiment_version --checkpoint_path ./logs/svg-latte-hparamsearch/S12.03__BestHparams__Seed-27_09.18_18.39.49/checkpoints/epoch=479-step=193440.ckpt
