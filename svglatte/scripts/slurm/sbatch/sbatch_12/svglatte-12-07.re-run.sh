...
python -m svglatte.train \
 ...
 --experiment_version 'S12.07__BestHparams__Seed=64_09.18_18.39.48' \
 --seed 64 \
 --gpus -1 \
 --n_epochs 600 \
 ...
 --test_only --do_not_add_timestamp_to_experiment_version --checkpoint_path logs/svg-latte-hparamsearch/S12.07__BestHparams__Seed-64_09.18_18.39.48_S12.07__BestHparams__Seed=64_09.18_18.39.48/checkpoints/epoch=539-step=217620.ckpt \
